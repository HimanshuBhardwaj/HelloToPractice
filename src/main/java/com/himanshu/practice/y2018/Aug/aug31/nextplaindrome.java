package com.himanshu.practice.y2018.Aug.aug31;
...
public class nextplaindrome {
    ...
    static void generateNextPalindromeUtil(int num[], int n) {
        ...
        // SourceA bool variable to check if copy of left
        // side to right
    ...
    // SourceA utility function to check if num has all 9s
    ...
    static long nextPalindrome(long n) {
        ...
        generateNextPalindrome(arr, numdigits);
        long num = 0;
        for (int x : arr) {
            num = (num * 10) + x;
